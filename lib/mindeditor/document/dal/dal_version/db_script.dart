...
class DbVersion1 extends DbScript {
  ...
  static Map<String, String> sql = {
    ...
    'Create objects': 'CREATE TABLE IF NOT EXISTS objects(obj_hash TEXT PRIMARY KEY, data TEXT, updated_at INTEGER)',
    'Create docs': 'CREATE TABLE IF NOT EXISTS doc_list(doc_id TEXT PRIMARY KEY, doc_hash TEXT, updated_at INTEGER)',
