...
class DbVersion1 extends DbScript {
  ...
  static Map<String, String> sql = {
    ...
    'Create versions': 'CREATE TABLE IF NOT EXISTS versions(tree_hash TEXT PRIMARY KEY, parents TEXT, created_at INTEGER, created_from INTEGER, status INTEGER, sync_status INTEGER)',
