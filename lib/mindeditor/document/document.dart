...
class Document {
  ...
  factory Document.createDocument(DbHelper db, String title, String content, DocumentManager parent, int now, int orderId, {String? parentDocId}) {
    final docId = db.newDocument(now, orderId, parentDocId: parentDocId);
