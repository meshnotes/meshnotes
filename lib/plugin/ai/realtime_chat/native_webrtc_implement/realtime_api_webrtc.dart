// /// Currently disable for two reasons:
// /// 1. flutter_webrtc is not ready for windows, will get an error: 
// ///            channel sent a message from native to Flutter on a non-platform thread. Platform channel messages must be sent on the 
...
// /// 2. Will cause the app size significantly increase(100M for apk, 50M for aab), because flutter_webrtc is 10MB itself.
// /// Just save it for future use, maybe one day flutter_webrtc will be optimized
//
// import 'dart:io';
// import 'dart:convert';
