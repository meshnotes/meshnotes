...
- [ ] **Relay Server Node-to-Node Sync**: Implement `publishAppType` handling to broadcast and relay document version updates among peer nodes.
- [ ] **Relay Server Query Resolution**: Implement `queryAppType` handling to reply to client queries for missing version trees or version data.
